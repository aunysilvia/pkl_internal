...
<div class="card product-card h-100 border-0 shadow-sm">
    ...
    <div class="position-relative">
        ...
        {{-- Wishlist Button --}}
        @auth
        <button type="button" onclick="toggleWishlist({{ $product->id }})" class="btn btn-light btn-sm position-absolute top-0 end-0 m-2 rounded-circle wishlist-btn-{{ $product->id }}">
