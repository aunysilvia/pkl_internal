    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="position-relative">
                    <img src="{{ $product->image_url }}" id="main-image" class="card-img-top" alt="{{ $product->name }}" style="height: 400px; object-fit: contain; background: #f8f9fa;">
                ...
                <div class="card-body">
                    <div class="d-flex gap-2 overflow-auto">
                        ...
                        <img src="{{ asset('storage/' . $image->image_path) }}" class="rounded border cursor-pointer" style="width: 80px; height: 80px; object-fit: cover; cursor: pointer;" onclick="document.getElementById('main-image').src = this.src">
                        @endforeach
                    </div>
                </div>
                @endif
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    {{-- Category --}}
                    <a href="{{ route('catalog.index', ['category' => $product->category->slug]) }}" class="badge bg-light text-dark text-decoration-none mb-2">
                        {{ $product->category->name }}
                    </a>
                    ...
                    {{-- Wishlist --}}
                    @auth
                    <button type="button" onclick="toggleWishlist({{ $product->id }})" class="btn btn-outline-danger mb-4 wishlist-btn-{{ $product->id }}">
